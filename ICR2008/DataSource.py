...
frame = [ds, ds2]
newds = pd.concat(frame, axis = 0, sort = False) 
newds = newds[["I_DS_NAME", "I_CDS_NAME", "I_DESCM_EN", "I_LUNIT_AO", "I_LUNIT_C_FIELD", "I_LUNIT_ENTITY_CDS", "I_LUNIT_FIELD", "I_PUNIT_C_FIELD", "I_PUNIT_FIELD","I_DESCL_EN"]]
...
new_ds_conv = pd.concat(frame, axis = 0, sort = False) 
